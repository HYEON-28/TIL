...
- 모바일앱 유저 마케팅 커뮤니케이션 서비스
- SMS로 확인메시지 보내야함. 유저는 답변가능해야함. 1년동안 보관해야함
...
- 금융회사의 고객. 금융 조언자와의 약속을 요청함 메시지 전송해서
- EC2가 받음 -> SQS -> EC2 -> 확인메일...
---
D
...
- 온프레미스 마케팅 웹사이트. 정적문서와 싱글서버로 이루어짐. 웹사이트 내용을 비정기적으로 업데이트하고 SFTP 사용함
- cloudfront 쓸거임
- 비용효율, 튼튼
...
- 비동기 API 유저요청 처리, 마이크로서비스에 던짐
- dynamoDB쓰고싶은데 가용성이슈랑 데이터 읽어버림
---
D
...
- EC2에서 S3로 데이터 이전 필요. 퍼블릿 인터넷 통하며 안됨
---
B
