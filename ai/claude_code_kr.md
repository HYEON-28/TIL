...
- 사용예시
  `Create user login feature email, password 사용 JWT token auth 로그인 실패 시 error message 표시`
- 기술영어는 영어 그대로!
- 파일명, 함수명은 절대 번역 금지
...
Backend: Node.js + ExpressDB: PostgreSQL
State: Redux Toolkit
Test: Jest + RTL
## Code Style
Functional components Airbnb ESLint
...
form validation은 Yup 
사용에러 처리는 ErrorBoundary 활용
```
